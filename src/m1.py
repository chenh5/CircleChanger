...
class CircleChanger(object):
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        ################################################################
        radius = self.circle.radius + amount_to_swell_or_shrink
        if radius < 1:
            radius = 1
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        point1 = self.circle.center
        point2 = other_circle_changer.circle.center
        center = point1.halfway_to(point2)
        radius = 0.5 * point1.get_distance_from(point2)
